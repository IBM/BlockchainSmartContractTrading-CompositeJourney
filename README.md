...
#### Artifacts
* Crypto material has been generated using the **cryptogen** tool from Hyperledger Fabric and mounted to all peers, the orderering node and CA containers. More details regarding the cryptogen tool are available [here](https://github.com/IBM/BlockchainNetwork-CompositeJourney#3a-crypto-generator).
* An Orderer genesis block (genesis.block) and channel configuration transaction (mychannel.tx) has been pre generated using the **configtxgen** tool from Hyperledger Fabric and placed within the artifacts folder. More details regarding the configtxgen tool are available [here](https://github.com/IBM/BlockchainNetwork-CompositeJourney#3b-configuration-transaction-generator).
...
* Execute the REST APIs from the section [Sample REST APIs Requests](#sample-rest-apis-requests)
...
## Reference
* This example is based on [Balance Transfer Application](https://github.com/hyperledger/fabric-samples/tree/release/balance-transfer). 
